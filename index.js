...
fastify.all('/incoming-call', async (request, reply) => {
    const twimlResponse = `<?xml version="1.0" encoding="UTF-8"?>
                          <Response>
                              <Say>Please wait while we connect your call to the Swiftie gee pee tee A eye voice assistant, powered by Twilio, Astra DB and the Open-A.I. Realtime API</Say>
                              <Pause length="1"/>
                              <Say>O.K. you can start asking about Taylor now!</Say>
                              <Connect>
